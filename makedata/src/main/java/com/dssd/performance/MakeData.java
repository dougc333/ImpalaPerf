...
public class MakeData {
	private static final int numRowsPerMonth_ = 5000;
	private static final int numRowsPerDay_ = 500;
	
	public static void main(String []args){
	try{
          
	  BufferedWriter bw = new BufferedWriter(new FileWriter("/testhdfsvol/testdata100chars.csv"));
	  int numRows=0;
